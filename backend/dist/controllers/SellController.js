...
exports.infoSell = exports.historySell = exports.dashboardSell = exports.confirmSell = exports.removeSell = exports.listSell = exports.createSell = void 0;
...
exports.listSell = listSell;
const removeSell = async (req, res) => {
    const requestId = (0, uuid_1.v4)();
    const { id } = req.params;
    try {
...
const confirmSell = async (req, res) => {
    const requestId = (0, uuid_1.v4)();
    try {
...
exports.confirmSell = confirmSell;
const dashboardSell = async (req, res) => {
    const requestId = (0, uuid_1.v4)();
    try {
...
exports.dashboardSell = dashboardSell;
const historySell = async (req, res) => {
    const requestId = (0, uuid_1.v4)();
    try {
        const response = await prisma.sell.findMany({
            where: {
...
exports.historySell = historySell;
const infoSell = async (req, res) => {
    const requestId = (0, uuid_1.v4)();
    try {
        const { id } = req.params;
