        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
              ...
              <div className="flex justify-center mb-2 sm:mb-3">
                <div className="relative">
                  ...
                  <div className="relative bg-white/20 backdrop-blur-sm rounded-full p-2.5 sm:p-3">
                    <i className="fa-solid fa-user-plus text-white text-2xl sm:text-3xl"></i>
                  </div>
                </div>
              </div>

              <h1 className="text-xl sm:text-2xl font-bold text-white mb-1">Mobile Repair</h1>
              <p className="text-blue-100 text-xs">สร้างบัญชีใหม่</p>
            </div>
          </div>
          ...
          <div className="p-4 sm:p-6 space-y-3">
            <div className="text-center mb-2">
              <h2 className="text-lg sm:text-xl font-bold text-gray-800 mb-1">ลงทะเบียน</h2>
              <p className="text-xs text-gray-600">กรอกข้อมูลเพื่อสร้างบัญชีใหม่</p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-2.5 sm:px-3 py-2 sm:py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all text-sm bg-gray-50 hover:bg-white"
                />
              </div>
            ...
            <div>
              <label htmlFor="username" className="block text-xs font-semibold text-gray-700 mb-1.5">
                <i className="fa-solid fa-id-card text-blue-600 mr-1.5"></i>
                ชื่อผู้ใช้
              </label>
              <input
                id="username"
                ...
                onKeyDown={handleKeyDown}
                className="w-full px-3 py-2 sm:py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all text-sm bg-gray-50 hover:bg-white"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onKeyDown={handleKeyDown}
                  className="w-full px-3 py-2 sm:py-2.5 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all text-sm bg-gray-50 hover:bg-white"
                />
                <button
                  type="button"
